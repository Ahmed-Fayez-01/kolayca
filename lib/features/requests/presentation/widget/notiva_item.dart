        ...
        child: Row(
          children: [
            ClipRRect(
                ...
                child: DefaultCachedNetworkImage(imageUrl: "https://www.lovepanky.com/wp-content/uploads/2020/11/what-makes-a-man-a-man-1.jpg", imageHeight: 80.sp, imageWidth: 80.sp)),
            ...
            Column(
              children: [
                Container(
                  ...
                  child: Text("3",style: AppTextStyle.aljazeera400Style21.copyWith(
                    color: Colors.white,
                    fontSize: 20.sp
                  ),),
                ),
