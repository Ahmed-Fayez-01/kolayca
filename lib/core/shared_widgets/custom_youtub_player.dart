...
// import 'package:youtube_player_flutter/src/widgets/play_pause_button.dart';
                        ...
                        child: Row(
                          children: widget.bottomActions ??
                              [
                                ...
                                if (widget.showDuration) RemainingDuration(),
                                if (widget.showSpeedButton) ...[
                                  SizedBox(width: 20.r),
...
class CustomFullScreenButton extends StatefulWidget {
  ...
  final YoutubePlayerController? controller;
  final CustomYoutubePlayer youtubePlayer;

  /// Defines color of the button.
  final Color color;

  /// Creates [CustomFullScreenButton] widget.
  ...
  @override
  _CustomFullScreenButtonState createState() => _CustomFullScreenButtonState();
}
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => CustomFullScreen(
                      youtubePlayer: widget.youtubePlayer,
                    )),
          );
        }
      },
...
class CustomFullScreen extends StatelessWidget {
  const CustomFullScreen({super.key, required this.youtubePlayer});
  final CustomYoutubePlayer youtubePlayer;
  @override
  Widget build(BuildContext context) {
